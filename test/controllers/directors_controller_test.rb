...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { awards: @director.awards, career: @director.career, name: @director.name } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { awards: @director.awards, career: @director.career, name: @director.name } }
